    ...
    <aside className="h-full w-60 bg-[#0d0d1a] border-r border-white/[0.05] flex flex-col">
      ...
      <div className="p-3 border-t border-white/[0.05] space-y-1">
        <div className="flex items-center gap-2 px-1 py-1">
          <button onClick={toggle} className="flex items-center justify-center w-8 h-8 rounded-lg text-slate-400 hover:text-white hover:bg-white/[0.06] transition-all">
