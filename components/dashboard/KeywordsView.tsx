        ...
        <div className="px-5 py-4 border-b border-[var(--border)] flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full bg-[var(--bg-input)] border border-[var(--border2)] rounded-xl pl-9 pr-4 py-2 text-sm text-[var(--text-base)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--border2)] transition-all"
            />
          </div>
            ...
            {tabs.map(t => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                  activeTab === t.key
                    ? 'bg-[var(--bg-card2)] text-[var(--c1)] border border-[var(--border)] dark:text-[var(--c1)]'
                  ...
                  <td className="px-4 py-3.5">
                    <div className="flex flex-wrap gap-1">
                      {row.keywords.slice(0, 5).map(kw => (
                        <span key={kw} className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--bg-card2)] border border-[var(--border)] text-[var(--c1)] dark:text-[var(--c1)]">
                          {kw}
                        </span>
                      ))}
                    </div>
