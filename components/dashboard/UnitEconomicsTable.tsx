              ...
              <button key={col.key}
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                  visibleCols.has(col.key) || col.always
                    ...
                    : 'bg-white/[0.03] text-[var(--text-muted)] border border-[var(--border)] hover:text-[var(--text-dim)]'
            ...
            {[
              ...
              <label key={key} className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[var(--bg-base)] border border-[var(--border)] rounded-lg text-sm text-[var(--text-base)] focus:outline-none focus:border-violet-500/50"
                />
              </label>
            ))}
                          ...
                          {editingSupplier === item.id ? (
                            <div className="flex items-center gap-1">
                              <input ref={supplierRef}
                                ...
                                className="w-32 px-2 py-1 bg-[var(--bg-base)] border border-violet-500/50 rounded text-xs text-[var(--text-base)] focus:outline-none"
                                autoFocus />
