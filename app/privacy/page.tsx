    ...
    sections: [
      {
        ...
        short: 'Umumiy',
        body: `Daromadchi — Uzbekiston bozorlarida (Uzum Market, Yandex Market) savdo qiluvchi sotuvchilar uchun mo\'ljallangan analitika platformasidir. Ushbu siyosat "Shaxsiy ma\'lumotlar to\'g\'risida"gi O\'zbekiston Respublikasi Qonuni (2019-yil 2-iyul, ZRU-547-son), 1125-son Qonun bilan kiritilgan o\'zgartishlar (2026-yil 27-martdan kuchga kirgan) va "Axborotlashtirish to\'g\'risida"gi Qonun (2003-yil 11-dekabr, 560-II-son) asosida tuzilgan.\n\nMa\'lumotlar operatori: YATT Xakimjonov Jamshid (yakka tartibdagi tadbirkor), INN 51608028660035, O\'zbekiston Respublikasi. «Daromadchi» — xizmat nomi.`,
      },
      {
        heading: '2. Qanday ma\'lumotlar to\'planadi',
        short: 'Ma\'lumotlar',
        body: `• Hisob ma\'lumotlari: elektron pochta manzili va bcrypt bilan xeshlangan parol — biz ochiq matn parolga hech qachon ega bo\'lmaymiz.\n• Do\'kon ma\'lumotlari: siz kiritgan marketplace API kaliti (AES-256 bilan shifrlangan holda saqlanadi).\n• Savdo ma\'lumotlari: marketplace API orqali olingan buyurtmalar, mahsulotlar, zaxira va reklama statistikasi.\n• Brauzer kengaytmasi ma\'lumotlari: kengaytma o\'rnatilsa, marketplace sahifalaridan (Uzum, Yandex Market) narx va mahsulot ma\'lumotlari to\'planadi — faqat siz kirgan hisob doirasida.\n• Telegram ma\'lumotlari: ogohlantirishlar yoqilganda foydalanuvchining Telegram chat ID si saqlanadi — faqat xabarnoma yuborish uchun.\n• Texnik ma\'lumotlar: brauzer turi, IP-manzil (xavfsizlik maqsadida), tizim jurnallari.\n\nBiz to\'lov kartasi ma\'lumotlari, hujjat nusxalari yoki boshqa maxsus kategoriyali shaxsiy ma\'lumotlarni to\'plamaymiz.\n\nDaromadchi marketplace xaridorlarining shaxsiy ma\'lumotlarini (ism, telefon, yetkazib berish manzili, email) to\'plamaydi va saqlamaydi — faqat sotuvchining o\'z hisob ma\'lumotlari va do\'konining umumlashtirilgan savdo statistikasi qayta ishlanadi.`,
      },
      {
        heading: '3. Ma\'lumotlar qanday ishlatiladi',
        short: 'Ishlatilishi',
        body: `• Dashboard ko\'rsatkichlarini, hisobotlarni va ogohlantirishlarni yaratish.\n• Marketplace API bilan sinxronizatsiya — sukut bo\'yicha faqat o\'qish rejimi: siz do\'kon uchun ixtiyoriy ostatok sinxronizatsiyasi rejimini o\'zingiz yoqmaguningizcha biz do\'koningizda hech narsa o\'zgartirmaymiz; yoqilganda ham faqat ostatok (qoldiq soni) yangilanadi, boshqa hech narsa emas.\n• Xavfsizlik: ruxsatsiz kirishni aniqlash va oldini olish.\n• Xizmat yaxshilash: anonim foydalanish statistikasi.\n\nBiz sizning ma\'lumotlaringizni uchinchi shaxslarga sotmaymiz va reklama maqsadida foydalanmaymiz.`,
      },
      {
        heading: '4. Saqlash va xavfsizlik',
        short: 'Xavfsizlik',
        body: `Ma\'lumotlar Hetzner Online GmbH (infratuzilma provayderi; data-markaz — Xelsinki, Finlyandiya) ijaraga olingan serverida joylashgan PostgreSQL ma\'lumotlar bazasida saqlanadi. Ma\'lumotlar bazasi to\'liq daromadchi tomonidan boshqariladi — uchinchi tomon boshqariladigan ma\'lumotlar bazasi xizmati ishlatilmaydi. API kalitlari AES-256-CBC algoritmi bilan shifrlangan holda saqlanadi. Parollar bcrypt bilan xeshlanadi. Barcha uzatmalar HTTPS (TLS 1.2+) orqali amalga oshiriladi.\n\nUchinchi shaxslar: Hetzner Online GmbH (fizik server ijarasi; data-markaz — Xelsinki, Finlyandiya) va Telegram Messenger LLP (bildirishnomalar yuborilganda, ixtiyoriy). Boshqa uchinchi shaxslarga ma\'lumot uzatilmaydi.\n\nZRU-547 Qonuni talablariga ko\'ra, shaxsiy ma\'lumotlar faqat zarur muddat davomida saqlanadi va hisobni o\'chirish so\'rovidan keyin 30 kun ichida o\'chiriladi. Moliyaviy va hisob-kitob hujjatlari (hisob-fakturalar, to\'lovlar, hisob-kitob ma\'lumotlari) soliq va buxgalteriya qonunchiligi talab qilgan hollarda uzoqroq saqlanishi mumkin.\n\nMa\'lumotlaringiz O\'zbekiston Respublikasidan tashqarida (Finlyandiya) qayta ishlanishi va saqlanishi mumkin; Daromadchi\'dan foydalanib, siz ushbu transchegaraviy qayta ishlashga rozilik bildirasiz. O\'zgartirilgan Qonunga ko\'ra, nozik bo\'lmagan shaxsiy ma\'lumotlar qonunda belgilangan shartlar asosida chet elda saqlanishi mumkin; biz rasmiy «adekvatlik» tan olinishini da\'vo qilmaymiz, chunki Vazirlar Mahkamasining adekvat davlatlar ro\'yxati hali tasdiqlanmagan.`,
      },
      {
        heading: '5. Foydalanuvchi huquqlari',
        short: 'Huquqlar',
        body: `ZRU-547 Qonuniga asosan sizda quyidagi huquqlar mavjud:\n• Ma\'lumotlaringizni ko\'rish va nusxa olish huquqi.\n• Ma\'lumotlarni to\'g\'irlash yoki o\'chirish talabi.\n• Ma\'lumotlarni qayta ishlashga rozilikni qaytarib olish.\n• Ma\'lumotlaringizni boshqa xizmatga ko\'chirish (portativlik).\n\nHuquqlaringizni amalga oshirish uchun bizga murojaat qiling: privacy@daromadchi.uz (yoki Telegram: @daromadchi_alerts_bot). So\'rovlar 15 ish kuni ichida ko\'rib chiqiladi.`,
      },
      {
        heading: '6. Cookie va kuzatuv',
        short: 'Cookie',
        body: `Biz zarur funktsional cookie-fayllardan (sessiya autentifikatsiyasi, til sozlamalari) va, faqat roziligingiz bilan, Google Analytics 4 (anonim _ga cookie) dan foydalanamiz. Analitika faqat siz cookie bannerida «Qabul qilish»ni bosgandan keyin yuklanadi; «Rad etish»da umuman yuklanmaydi. Batafsil — Cookie siyosatimizda. Uchinchi tomon reklama cookie-lari ishlatilmaydi.`,
      },
      {
      ...
      },
      {
        heading: '10. Aloqa',
        short: 'Aloqa',
        body: `Savollar, shikoyatlar yoki huquqiy so\'rovlar uchun:\nElektron pochta: privacy@daromadchi.uz\nTelegram: @daromadchi_alerts_bot\n\nNazorat organlari: O\'zbekiston Respublikasi Adliya vazirligi huzuridagi Shaxsiylashtirish agentligi (Shaxsiy ma\'lumotlar bazalarining Davlat reestrini yuritadi) va «Uzkomnazorat» davlat inspeksiyasi. Shuningdek sudga murojaat qilishingiz mumkin.`,
      },
    ],
  },
  ru: {
    ...
    sections: [
      { heading: '1. Общие сведения', short: 'Общее',
        body: `Daromadchi — аналитическая платформа для продавцов на маркетплейсах Узбекистана (Uzum Market, Yandex Market). Настоящая политика разработана в соответствии с Законом РУз «О персональных данных» (2 июля 2019 г., ЗРУ-547) с изменениями, внесёнными Законом № 1125 (вступил в силу 27 марта 2026 г.), и Законом «Об информатизации» (11 декабря 2003 г., № 560-II).\n\nОператор персональных данных: ЯТТ Хакимжонов Жамшид (индивидуальный предприниматель), ИНН 51608028660035, Республика Узбекистан. «Daromadchi» — наименование сервиса.` },
      { heading: '2. Какие данные собираются', short: 'Данные',
        body: `• Учётные данные: адрес электронной почты и хеш пароля (bcrypt) — мы никогда не имеем доступа к открытому тексту пароля.\n• Данные магазина: API-ключ маркетплейса, введённый вами (хранится в зашифрованном виде AES-256).\n• Торговые данные: заказы, товары, запасы и рекламная статистика, полученные через API маркетплейса.\n• Данные браузерного расширения: при установке расширения со страниц маркетплейсов собираются цены и данные о товарах — только в рамках вашей учётной записи.\n• Данные Telegram: при включении уведомлений сохраняется Telegram chat ID — исключительно для отправки уведомлений.\n• Технические данные: тип браузера, IP-адрес (в целях безопасности), системные журналы.\n\nМы не собираем данные платёжных карт, копии документов или иные специальные категории персональных данных.\n\nDaromadchi не собирает и не хранит персональные данные покупателей маркетплейсов (имена, телефоны, адреса доставки, email) — обрабатываются только данные учётной записи самого продавца и агрегированная торговая статистика его магазина.` },
      { heading: '3. Как используются данные', short: 'Использование',
        body: `• Формирование показателей панели управления, отчётов и уведомлений.\n• Синхронизация с API маркетплейса — по умолчанию только чтение: мы ничего не меняем в вашем магазине, пока вы сами не включите необязательный режим синхронизации остатков для магазина; и даже тогда обновляется только количество (остаток) и ничего больше.\n• Безопасность: обнаружение и предотвращение несанкционированного доступа.\n• Улучшение сервиса: анонимная статистика использования.\n\nМы не продаём ваши данные третьим лицам и не используем их в рекламных целях.` },
      { heading: '4. Хранение и безопасность', short: 'Безопасность',
        body: `Данные хранятся в базе PostgreSQL, развёрнутой на выделенном сервере Hetzner Online GmbH (провайдер инфраструктуры; дата-центр — Хельсинки, Финляндия). База данных полностью управляется командой daromadchi — сторонняя managed-DB-услуга не используется. API-ключи шифруются алгоритмом AES-256-CBC. Пароли хешируются bcrypt. Все передачи данных осуществляются по протоколу HTTPS (TLS 1.2+).\n\nТретьи лица: Hetzner Online GmbH (аренда физического сервера; дата-центр — Хельсинки, Финляндия) и Telegram Messenger LLP (при отправке уведомлений, опционально). Иным третьим лицам данные не передаются.\n\nВ соответствии с Законом ЗРУ-547 персональные данные хранятся только в течение необходимого срока и удаляются в течение 30 дней после запроса на удаление аккаунта. Финансовые и расчётные документы (счета, платежи, данные о выплатах) могут храниться дольше, если этого требует налоговое и бухгалтерское законодательство.\n\nВаши данные могут обрабатываться и храниться за пределами Республики Узбекистан (в Финляндии); используя Daromadchi, вы даёте согласие на такую трансграничную обработку. Согласно Закону (в редакции с изменениями), несенситивные персональные данные могут храниться за рубежом при соблюдении условий закона; мы не заявляем о наличии официального признания «адекватности», поскольку перечень адекватных стран Кабинета Министров ещё не утверждён.` },
      { heading: '5. Права пользователей', short: 'Права',
        body: `На основании Закона ЗРУ-547 вы имеете право:\n• Получить доступ к своим данным и их копию.\n• Потребовать исправления или удаления данных.\n• Отозвать согласие на обработку данных.\n• Перенести свои данные в другой сервис.\n\nДля реализации своих прав обращайтесь: privacy@daromadchi.uz (или Telegram: @daromadchi_alerts_bot). Запросы рассматриваются в течение 15 рабочих дней.` },
      { heading: '6. Куки и отслеживание', short: 'Куки',
        body: `Мы используем необходимые функциональные куки (сессионная аутентификация, настройки языка) и — только с вашего согласия — Google Analytics 4 (анонимный cookie _ga). Аналитика загружается только после нажатия «Принять» в баннере cookie; при «Отклонить» не загружается вовсе. Подробнее — в нашей Политике cookie. Сторонние рекламные куки не применяются.` },
      ...
      { heading: '10. Контакты', short: 'Контакты',
        body: `По вопросам, жалобам или юридическим запросам:\nЭлектронная почта: privacy@daromadchi.uz\nTelegram: @daromadchi_alerts_bot\n\nНадзорные органы: Агентство персонализации при Министерстве юстиции Республики Узбекистан (ведёт Государственный реестр баз персональных данных) и государственная инспекция «Узкомназорат». Вы также вправе обратиться в суд.` },
    ],
  },
  en: {
    ...
    sections: [
      { heading: '1. About', short: 'About',
        body: `Daromadchi is an analytics platform for sellers on Uzbekistan marketplaces (Uzum Market, Yandex Market). This policy is prepared in compliance with the Law of the Republic of Uzbekistan "On Personal Data" (2 July 2019, ZRU-547), as amended by Law No. 1125 (in force 27 March 2026), and the Law "On Informatization" (11 December 2003, No. 560-II).\n\nData operator: YATT Xakimjonov Jamshid (individual entrepreneur), INN 51608028660035, Republic of Uzbekistan. "Daromadchi" is the name of the service.` },
      { heading: '2. What data we collect', short: 'Data',
        body: `• Account data: email address and a bcrypt password hash — we never have access to the plain-text password.\n• Shop data: the marketplace API key you provide (stored encrypted with AES-256).\n• Trading data: orders, products, stock levels and ad statistics fetched via the marketplace API.\n• Browser extension data: if the extension is installed, price and product data is collected from marketplace pages — only within your logged-in account.\n• Telegram data: when alerts are enabled, your Telegram chat ID is stored solely for sending notifications.\n• Technical data: browser type, IP address (for security purposes), system logs.\n\nWe do not collect payment card details, identity document copies, or other special-category personal data.\n\nDaromadchi does not collect or store marketplace customers' (buyers') personal data (names, phone numbers, delivery addresses, emails) — it processes only the seller's own account data and their store's aggregated sales statistics.` },
      { heading: '3. How data is used', short: 'Usage',
        body: `• Generating dashboard metrics, reports and alerts.\n• Marketplace API synchronisation — read-only by default: we never modify anything in your store unless you turn on the optional per-shop Stock-sync mode, and even then only the stock quantity (ostatok) is updated, nothing else.\n• Security: detecting and preventing unauthorised access.\n• Service improvement: anonymous usage statistics.\n\nWe do not sell your data to third parties or use it for advertising purposes.` },
      { heading: '4. Storage & security', short: 'Security',
        body: `Data is stored in a PostgreSQL database on a dedicated server rented from Hetzner Online GmbH (infrastructure provider; data centre — Helsinki, Finland). The database is fully self-managed by daromadchi — no third-party managed-database service is used. API keys are encrypted with AES-256-CBC. Passwords are hashed with bcrypt. All data in transit is protected by HTTPS (TLS 1.2+).\n\nThird parties: Hetzner Online GmbH (physical server rental; data centre — Helsinki, Finland) and Telegram Messenger LLP (when notifications are sent, optional). No data is sold or shared with any other third parties.\n\nUnder Law ZRU-547, personal data is retained only as long as necessary and is deleted within 30 days of an account-deletion request. Financial and accounting records (invoices, payments, settlement data) may be retained longer where tax and accounting law requires.\n\nYour data may be processed and stored outside the Republic of Uzbekistan (in Finland); by using Daromadchi you consent to this cross-border processing. Under the amended Law, non-sensitive personal data may be stored abroad subject to the conditions of the law; we do not claim any official "adequacy" finding, as the Cabinet of Ministers' list of adequate countries has not yet been approved.` },
      { heading: '5. User rights', short: 'Rights',
        body: `Under Law ZRU-547 you have the right to:\n• Access and receive a copy of your data.\n• Request correction or deletion of your data.\n• Withdraw consent to data processing.\n• Data portability — transfer your data to another service.\n\nTo exercise your rights, contact us at privacy@daromadchi.uz (or Telegram: @daromadchi_alerts_bot). Requests are processed within 15 working days.` },
      { heading: '6. Cookies & tracking', short: 'Cookies',
        body: `We use essential functional cookies (session authentication, language preferences) and — only with your consent — Google Analytics 4 (the anonymous _ga cookie). Analytics loads only after you click "Accept" in the cookie banner and is never loaded if you decline. See our Cookie Policy for detail. No third-party advertising cookies are used.` },
      ...
      { heading: '10. Contact', short: 'Contact',
        body: `For questions, complaints or legal requests:\nEmail: privacy@daromadchi.uz\nTelegram: @daromadchi_alerts_bot\n\nSupervisory authorities: the Personalization Agency under the Ministry of Justice of the Republic of Uzbekistan (which maintains the State Register of Personal Data Bases) and the state inspectorate Uzkomnazorat. You may also apply to the courts.` },
    ],
  },
}
