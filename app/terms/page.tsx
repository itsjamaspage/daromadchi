...
// The notice period is the one the renewal actually enforces, interpolated
// rather than typed, so the document cannot promise a window the code does not
// keep — the mistake the trial copy made for weeks.
import { PRICE_NOTICE_DAYS } from '@/lib/billing/plans'
