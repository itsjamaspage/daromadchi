...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    body: {
      uz: `Operator (huquqiy shaxs): YATT Xakimjonov Jamshid (yakka tartibdagi tadbirkor)\nINN: 51608028660035\nFaoliyat joyi: Toshkent shahri, O'zbekiston Respublikasi\nMa'lumotlar bo'yicha aloqa: privacy@daromadchi.uz\nTelegram (ixtiyoriy): @daromadchi_alerts_bot\n«Daromadchi» — xizmat nomi.\n\nOperator ZRU-547 Qonuni asosida shaxsiy ma'lumotlar operatori sifatida O'zbekiston Respublikasi Adliya vazirligi huzuridagi Shaxsiylashtirish agentligi yuritadigan Shaxsiy ma'lumotlar bazalarining Davlat reestriga kiritilish jarayonini olib bormoqda. Nazorat organlari — Shaxsiylashtirish agentligi va «Uzkomnazorat» davlat inspeksiyasi.\n\nYosh chegarasi:\nDaromadchi 13 yoshdan kichik bolalarga mo'ljallanmagan. Bu biznes tahlil vositasi bo'lib, foydalanuvchilar kamida 18 yoshda bo'lishi tavsiya etiladi. Agar biz 13 yoshdan kichik shaxsga oid ma'lumotlarni to'plaganimizni aniqlasak, ular darhol o'chiriladi.`,
      ru: `Оператор (юридическое лицо): ЯТТ Хакимжонов Жамшид (индивидуальный предприниматель)\nИНН: 51608028660035\nМесто деятельности: г. Ташкент, Республика Узбекистан\nКонтакт по данным: privacy@daromadchi.uz\nTelegram (опционально): @daromadchi_alerts_bot\n«Daromadchi» — наименование сервиса.\n\nОператор проходит процедуру включения в Государственный реестр баз персональных данных, который ведёт Агентство персонализации при Министерстве юстиции Республики Узбекистан, в качестве оператора персональных данных в соответствии с Законом ЗРУ-547. Надзорные органы — Агентство персонализации и государственная инспекция «Узкомназорат».\n\nВозрастное ограничение:\nDaromadchi не предназначен для лиц младше 13 лет. Поскольку это инструмент бизнес-аналитики, пользователям рекомендуется быть не моложе 18 лет. При обнаружении данных лица младше 13 лет они будут незамедлительно удалены.`,
      en: `Operator (legal person): YATT Xakimjonov Jamshid (individual entrepreneur)\nINN: 51608028660035\nPlace of business: Tashkent, Republic of Uzbekistan\nData contact: privacy@daromadchi.uz\nTelegram (optional): @daromadchi_alerts_bot\n"Daromadchi" is the name of the service.\n\nThe operator is undergoing registration in the State Register of Personal Data Bases maintained by the Personalization Agency under the Ministry of Justice of the Republic of Uzbekistan, as a personal data operator under Law ZRU-547. The supervisory authorities are the Personalization Agency and the state inspectorate Uzkomnazorat.\n\nAge restriction:\nDaromadchi is not intended for persons under 13. As a business analytics tool, users are recommended to be at least 18 years old. If we discover personal data of a person under 13 has been collected, it will be deleted immediately.`,
    },
  },
  {
    ...
    body: {
      uz: `Daromadchi veb-ilovasida quyidagi ma'lumotlar qayta ishlanadi:\n\n📧 Hisob ma'lumotlari\n• Elektron pochta manzili — identifikatsiya va sessiya boshqaruvi uchun\n• Parol bcrypt algoritmi bilan xeshlangan holda saqlanadi — biz hech qachon ochiq matn paroliga kirish imkoniga ega emasmiz\n\n🔑 Do'kon ulanish ma'lumotlari\n• Marketplace API kaliti (sukut bo'yicha faqat o'qish uchun; ixtiyoriy ostatok sinxronizatsiyasi rejimi undan faqat ostatok sonini yangilash uchun foydalanadi — boshqa hech narsa emas; AES-256-CBC bilan shifrlangan holda saqlanadi)\n• Maqsad: Uzum yoki Yandex Market hisobingizdan savdo ma'lumotlarini olish\n\n📊 Savdo ma'lumotlari\n• Buyurtmalar, mahsulotlar, ombor qoldiqlari, reklama xarajatlari — marketplace API orqali olinadi\n• Ushbu ma'lumotlar sizning do'koningizga tegishli va uchinchi shaxslarga uzatilmaydi\n\n📱 Telegram bildirishnomalar (ixtiyoriy)\n• Telegram chat ID — faqat savdo ogohlantirishlari yuborish uchun saqlanadi\n\n🔒 Texnik ma'lumotlar\n• IP-manzil — xavfsizlik va trafik chegaralash uchun (30 kun saqlanadi)\n• Sessiya tokeni — autentifikatsiya (NextAuth/Auth.js orqali imzolangan JWT, 30 kun amal qiladi)\n• Brauzer turi — diagnostika maqsadida\n• Tizim jurnallari — 90 kun saqlanadi\n\nBiz TO'PLAMAYMIZ:\n• To'lov kartasi ma'lumotlari\n• Shaxsni tasdiqlovchi hujjat nusxalari\n• Biometrik ma'lumotlar\n• Boshqa maxsus toifali shaxsiy ma'lumotlar\n\nMarketplace xaridorlari haqida: Daromadchi xaridorlarning shaxsiy ma'lumotlarini (ism, telefon, yetkazib berish manzili, email) to'plamaydi va saqlamaydi. Faqat sotuvchining hisob ma'lumotlari va do'konning umumlashtirilgan savdo statistikasi (buyurtmalar, qoldiq, tushum, SKU) qayta ishlanadi.`,
      ru: `В веб-приложении Daromadchi обрабатываются следующие данные:\n\n📧 Учётные данные\n• Адрес электронной почты — для идентификации и управления сессией\n• Пароль хранится в виде хеша bcrypt — мы никогда не имеем доступа к открытому тексту пароля\n\n🔑 Данные подключения магазина\n• API-ключ маркетплейса (по умолчанию используется только для чтения; необязательный режим синхронизации остатков использует его для обновления только количества/остатка — и ничего больше; хранится в зашифрованном виде AES-256-CBC)\n• Цель: получение торговых данных из вашего аккаунта Uzum или Yandex Market\n\n📊 Торговые данные\n• Заказы, товары, складские остатки, рекламные расходы — получены через API маркетплейса\n• Эти данные принадлежат вашему магазину и не передаются третьим лицам\n\n📱 Telegram-уведомления (опционально)\n• Telegram chat ID — хранится только для отправки торговых уведомлений\n\n🔒 Технические данные\n• IP-адрес — для безопасности и ограничения трафика (хранится 30 дней)\n• Токен сессии — для аутентификации (подписанный JWT через NextAuth/Auth.js, срок действия 30 дней)\n• Тип браузера — в диагностических целях\n• Системные журналы — хранятся 90 дней\n\nМЫ НЕ СОБИРАЕМ:\n• Данные платёжных карт\n• Копии удостоверяющих документов\n• Биометрические данные\n• Иные специальные категории персональных данных\n\nО покупателях маркетплейсов: Daromadchi не собирает и не хранит персональные данные покупателей (имена, телефоны, адреса доставки, email). Обрабатываются только данные учётной записи продавца и агрегированная торговая статистика магазина (заказы, остатки, выручка, SKU).`,
      en: `The Daromadchi web application processes the following data:\n\n📧 Account data\n• Email address — for identification and session management\n• Password stored as a bcrypt hash — we never have access to the plain-text password\n\n🔑 Store connection data\n• Marketplace API key (used read-only by default; the optional per-shop Stock-sync mode uses it to update only the stock quantity/ostatok — nothing else; stored encrypted with AES-256-CBC)\n• Purpose: fetching trading data from your Uzum or Yandex Market account\n\n📊 Trading data\n• Orders, products, stock levels, ad spend — fetched via the marketplace API\n• This data belongs to your store and is not shared with third parties\n\n📱 Telegram notifications (optional)\n• Telegram chat ID — stored only for sending trade alerts\n\n🔒 Technical data\n• IP address — for security and rate limiting (retained 30 days)\n• Session token — for authentication (signed JWT via NextAuth/Auth.js, valid 30 days)\n• Browser type — for diagnostic purposes\n• System logs — retained 90 days\n\nWE DO NOT COLLECT:\n• Payment card details\n• Identity document copies\n• Biometric data\n• Other special-category personal data\n\nAbout marketplace customers: Daromadchi does not collect or store buyers' personal data (names, phone numbers, delivery addresses, emails). Only the seller's account data and the store's aggregated sales statistics (orders, stock, revenue, SKUs) are processed.`,
    },
  },
  {
  ...
  },
  {
    ...
    body: {
      uz: `Daromadchi quyidagi xorijiy xizmat-provayderlardan foydalanadi:\n\nHetzner Online GmbH (data-markaz: Xelsinki, Finlyandiya)\n• Rol: Fizik server ijarasi (dedicated server hosting)\n• Kafolat: ISO 27001 sertifikatli data-markazi; GDPR-muvofiq operator (EL a'zosi)\n• Maqsad: Veb-ilovani, PostgreSQL ma'lumotlar bazasini va API kalitlari + savdo ma'lumotlari saqlanadigan diskni joylashtirish\n\nTelegram Messenger LLP (Buyuk Britaniya / BVI)\n• Rol: Bildirishnoma kanali (faqat siz Telegram bot bilan ulanishni yoqsangiz)\n• Maqsad: Sizning Telegram chat ID'ingizga savdo ogohlantirishlarini yuborish\n• Yuboriladigan ma'lumotlar: faqat bildirishnoma matni va sizning chat ID'ingiz\n\nHuquqiy asos:\nZRU-547 Qonuniga 1125-son Qonun bilan kiritilgan va 2026-yil 27-martda kuchga kirgan o'zgartishlar xorijiy bulut xizmatlaridan foydalanishga ruxsat beradi, agar axborot xavfsizligi talablari bajarilsa. Hetznerning ISO 27001 sertifikatsiyasi va Yevropa Ittifoqi GDPR rejimidagi joylashuvi ushbu talabga javob beradi.\n\nDaromadchi'dan foydalanib, siz ma'lumotlaringizni O'zbekiston Respublikasidan tashqarida (Finlyandiya) qayta ishlashga rozilik bildirasiz. Biz rasmiy «adekvatlik» tan olinishini da'vo qilmaymiz, chunki Vazirlar Mahkamasining adekvat davlatlar ro'yxati hali tasdiqlanmagan; uzatish qonunda belgilangan shartlar (axborot xavfsizligi va rozilik) asosida amalga oshiriladi.\n\nUshbu provayderlar o'z hisoblash operatsiyalari doirasida ma'lumotlarga kirish huquqiga ega. Ular ma'lumotlarni o'z maqsadlari uchun foydalanmaydi. Boshqa xorijiy tomonlarga ma'lumot uzatilmaydi.`,
      ru: `Daromadchi использует следующих зарубежных поставщиков услуг:\n\nHetzner Online GmbH (дата-центр: Хельсинки, Финляндия)\n• Роль: Аренда физического сервера (dedicated server hosting)\n• Гарантия: Дата-центр с сертификацией ISO 27001; оператор в юрисдикции ЕС (GDPR)\n• Цель: Размещение веб-приложения, базы данных PostgreSQL и дисков, где хранятся API-ключи и торговые данные\n\nTelegram Messenger LLP (Великобритания / БВО)\n• Роль: Канал уведомлений (только если вы подключаете Telegram-бота)\n• Цель: Отправка торговых уведомлений на ваш Telegram chat ID\n• Передаётся: только текст уведомления и ваш chat ID\n\nПравовое основание:\nИзменения к Закону ЗРУ-547, внесённые Законом № 1125 и вступившие в силу 27 марта 2026 г., разрешают использование иностранных облачных сервисов при соблюдении требований информационной безопасности. Сертификация ISO 27001 у Hetzner и его нахождение в юрисдикции ЕС (GDPR) удовлетворяют этому требованию.\n\nИспользуя Daromadchi, вы даёте согласие на обработку ваших данных за пределами Республики Узбекистан (в Финляндии). Мы не заявляем о наличии официального признания «адекватности», поскольку перечень адекватных стран Кабинета Министров ещё не утверждён; передача осуществляется на условиях, установленных законом (информационная безопасность и согласие).\n\nУказанные поставщики имеют доступ к данным только в рамках своих вычислительных операций. Они не используют данные в собственных целях. Данные не передаются иным зарубежным сторонам.`,
      en: `Daromadchi uses the following international service providers:\n\nHetzner Online GmbH (data centre: Helsinki, Finland)\n• Role: Dedicated server hosting\n• Assurance: ISO 27001-certified data centres; operator in EU jurisdiction (GDPR)\n• Purpose: Hosting the web application, the PostgreSQL database, and the disks where API keys and trading data are stored\n\nTelegram Messenger LLP (United Kingdom / BVI)\n• Role: Notification channel (only if you connect the Telegram bot)\n• Purpose: Sending trade alerts to your Telegram chat ID\n• Transmitted: notification text and your chat ID only\n\nLegal basis:\nAmendments to Law ZRU-547 introduced by Law No. 1125 (in force 27 March 2026) permit use of foreign cloud services where information security requirements are met. Hetzner's ISO 27001 certification and its location under the EU GDPR regime satisfy this requirement.\n\nBy using Daromadchi you consent to the processing of your data outside the Republic of Uzbekistan (in Finland). We do not claim any official "adequacy" finding, as the Cabinet of Ministers' list of adequate countries has not yet been approved; the transfer is carried out under the conditions set by law (information security and consent).\n\nThese providers access data only within their computing operations. They do not use data for their own purposes. No data is transferred to any other international parties.`,
    },
  },
  {
