    ...
    function render(){
      ...
      wrap.innerHTML=`
        ...
        <div style="padding:13px 14px;display:flex;flex-direction:column;gap:11px">
          ...
          <button id="drm-ue" style="display:block;width:100%;padding:11px;background:#16a34a;color:#fff;border:none;border-radius:10px;font-size:13px;font-weight:600;text-align:center">${l.ueBtn}</button>
